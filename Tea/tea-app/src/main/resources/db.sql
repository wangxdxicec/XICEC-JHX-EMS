...
create view ExhibitorList as 
select i.eid [ID],b.booth_number [ExhibitionNo], 
(SELECT c.CountryValue from WCountryInfo c where c.ID = e.country) [Country],
e.[Company],[CompanyE],e.[Company] [ShortCompanyName],
[CompanyE] [ShortCompanyNameE],[companyt] [ShortCompanyNameT], e.[Company] [FirstCompany],
